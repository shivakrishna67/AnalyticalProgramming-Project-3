def dataSummaryMod(api_endpoint):
    ...
    print(data.info())
    print("Pandas has considered the datatypes of attributes as displayed above by default, we would be converting them as per requirement(int/float) in further analysis.")
