def inferences(data):
    ...
    print("""Now that we've completed the Exploratory Data Analysis we'll perform the analysis required to answer the research question. For any visualizations necessary, I will create the graphic using both Matplotlib and Seaborn.""")
    print("""*********************************************************************
    ...
    ******************************************************************************
    ...
    month_bar_plot_matplotlib = data['Month'].value_counts().sort_values().plot(kind='bar')
    month_bar_plot_matplotlib.set_title('MATPLOTLIB: Number of Crashes per Month')
    month_bar_plot_matplotlib.set_xticklabels(month_bar_plot_matplotlib.get_xticklabels(), rotation=45)
    ...
    month_bar_plot_seaborn.set_xticklabels(month_bar_plot_seaborn.get_xticklabels(), rotation=45)
    ...
    *****************************************************************************""")
    ...
    hour
    plt.show()
    print("""Interesting there is a strong relation between the time of the day and the crashes. From EDA I found that mostly crashes has been happened only from 2pm to 7pm.""")
    ...
    **********************************************************************""")
    print("""There is a strong seasonality across the particular time of the day which is from 2pm to 7pm and among the months its first 3 quaters has large number of crashes with less varying number of crashes across the months of first 3 quaters.""")
